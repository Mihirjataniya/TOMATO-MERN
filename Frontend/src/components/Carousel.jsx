  ...
  return (
    <div className='w-full pt-24 px-10 object-contain py-4 max-sm:px-4'>
                <div className="relative h-[500px] max-sm:h-[250px] object-contain overflow-hidden rounded-lg w-full ">
                    ...
                    <button type="button" className="absolute top-0 start-0  flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={goToPrevSlide}>
                    ...
                    <button type="button" className="absolute top-0 end-0  flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={goToNextSlide}>
                        <span className="inline-flex items-center justify-center w-10 h-10 max-sm:h-7 max-sm:w-7 rounded-full bg-white/30    group-focus:ring-4   group-focus:outline-none">
                            <svg className="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
